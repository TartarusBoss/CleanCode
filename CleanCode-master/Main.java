...
public class Main {
    public static void main(String[] args) {
        ...
        Usuario usuario4 = new Usuario("Usuario4", "contraseña4", 4000.0);
        ...
        udemBank.registrarUsuario(usuario4);
        ...
        usuario4.iniciarSesion("contraseña4");
        ...
        GrupoDeAhorro grupo3 = new GrupoDeAhorro("Grupo3", 9000.0);
        GrupoDeAhorro grupo4 = new GrupoDeAhorro("Grupo4", 10000.0);

        // Agregar usuarios a grupos de ahorro
        grupo1.agregarMiembro(usuario1);
        grupo2.agregarMiembro(usuario1);
        grupo3.agregarMiembro(usuario1);
        grupo4.agregarMiembro(usuario1);
        grupo1.agregarMiembro(usuario3);
